...
library(openxlsx)
library(rEDM)
pdf("./plot/sample.pdf", width = 12, height = 6)
current_dir <- getwd()
...
df_climate <- df_climate[df_climate$Year %in% Time, ]

Time <-  df_subject[, Time]
...
df_subject_each_simplex <- apply(df_subject_each, 2, simplex, stats_only = F, lib = c(1, length(Time)), pred = c(1 , length(Time) + 1), E = 1:10)
...
{plot(c(df_subject_each[[1]], NA), type = "l", x = c(Time, Time[length(Time)] + 1), xlab = "Time", ylab = "DEN1_subject")
  lines(c(NA, df_subject_each_simplex[[1]]$model_output[[best_E_subject[1]]]$pred), type = "l", col = "red", x =c(Time, Time[length(Time)] + 1))}
{plot(c(df_subject_each[[2]], NA), type = "l", x = c(Time, Time[length(Time)] + 1), xlab = "Time", ylab = "DEN2_subject")
  lines(c(NA, df_subject_each_simplex[[2]]$model_output[[best_E_subject[2]]]$pred), type = "l", col = "red", x =c(Time, Time[length(Time)] + 1))}
{plot(c(df_subject_each[[3]], NA), type = "l", x = c(Time, Time[length(Time)] + 1), xlab = "Time", ylab = "DEN3_subject")
  lines(c(NA, df_subject_each_simplex[[3]]$model_output[[best_E_subject[3]]]$pred), type = "l", col = "red", x =c(Time, Time[length(Time)] + 1))}
{plot(c(df_subject_each[[4]], NA), type = "l", x = c(Time, Time[length(Time)] + 1), xlab = "Time", ylab = "DEN4_subject")
  lines(c(NA, df_subject_each_simplex[[4]]$model_output[[best_E_subject[4]]]$pred), type = "l", col = "red", x =c(Time, Time[length(Time)] + 1))}

df_rate_simplex <- apply(df_rate, 2, simplex, stats_only = F, lib = c(1, length(Time)), pred = c(1 , length(Time) + 1), E = 1:10)
...
{plot(c(df_rate[[1]], NA), type = "l", x = c(Time, Time[length(Time)] + 1), lwd = 2, xlab = "Time", ylab = "Ratio", main = "Changes in existence ratio type 1")
  lines(c(NA, df_rate_simplex[[1]]$model_output[[best_E_rate[1]]]$pred), lwd = 2, type = "l", col = "red", x =c(Time, Time[length(Time)] + 1))}
{plot(c(df_rate[[2]], NA), type = "l", x = c(Time, Time[length(Time)] + 1), lwd = 2, xlab = "Time", ylab = "Ratio", main = "Changes in existence ratio type 2")
  lines(c(NA, df_rate_simplex[[2]]$model_output[[best_E_rate[2]]]$pred), lwd = 2, type = "l", col = "red", x =c(Time, Time[length(Time)] + 1))}
{plot(c(df_rate[[3]], NA), type = "l", x = c(Time, Time[length(Time)] + 1), lwd = 2, xlab = "Time", ylab = "Ratio", main = "Changes in existence ratio type 3")
  lines(c(NA, df_rate_simplex[[3]]$model_output[[best_E_rate[3]]]$pred), lwd = 2, type = "l", col = "red", x =c(Time, Time[length(Time)] + 1))}
{plot(c(df_rate[[4]], NA), type = "l", x = c(Time, Time[length(Time)] + 1), lwd = 2, xlab = "Time", ylab = "Ratio", main = "Changes in existence ratio type 4")
  lines(c(NA, df_rate_simplex[[4]]$model_output[[best_E_rate[4]]]$pred), lwd = 2, type = "l", col = "red", x =c(Time, Time[length(Time)] + 1))}
