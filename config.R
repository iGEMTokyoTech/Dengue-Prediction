...
subject_data <- "/Users/ryogamisu/iGEM2018/Dengue-Prediction/data/denguevirus_infected_in_Bankok.xlsx"
...
climate_data <- "/Users/ryogamisu/iGEM2018/Dengue-Prediction/data/Climate_BANGKOK.xlsx"
